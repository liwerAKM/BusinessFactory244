...
{
 public    class DALapplysucess
    {
        public DALapplysucess()
        { }
        #region  BasicMethod
        ...
        public bool Add(Mapplyerror model)
        {
            ...
            strSql.Append("insert into applysucess(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update applysucess set ");
        ...
        public bool Delete()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from applysucess ");
            strSql.Append(" where ");
            MySqlParameter[] parameters = {
            };
        ...
        public Mapplyerror GetModel()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select applyTime,unifiedOrgCode,OrgName,billID,billCode,TotalMoney,idcardNo,PatName,EBPPType,PayType,PDFUrl,CreatTime,InData,OutData from applysucess ");
            strSql.Append(" where ");
            MySqlParameter[] parameters = {
            };
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM applysucess ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM applysucess ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from applysucess T ");
