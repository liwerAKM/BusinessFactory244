...
{
    /// <summary>
    /// 数据访问类:opt_pay_mx_lock
    /// </summary>
    public partial class opt_pay_mx_lock 
    {
        public opt_pay_mx_lock()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string PAY_ID, string FL_NO, string ITEM_TYPE, string ITEM_ID)
        {
            ...
            strSql.Append("select count(1) from opt_pay_mx_lock");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Plat.Model.opt_pay_mx_lock model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Plat.Model.opt_pay_mx_lock model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update opt_pay_mx_lock set ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Plat.Model.opt_pay_mx_lock GetModel(string PAY_ID, string FL_NO, string ITEM_TYPE, string ITEM_ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select PAY_ID,FL_NO,ITEM_TYPE,ITEM_ID,ITEM_NAME,ITEM_GG,COUNT,ITEM_UNIT,COST,je from opt_pay_mx_lock ");
            strSql.Append(" where PAY_ID=@PAY_ID and FL_NO=@FL_NO and ITEM_TYPE=@ITEM_TYPE and ITEM_ID=@ITEM_ID ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@PAY_ID", MySqlDbType.VarChar,10),
					new MySqlParameter("@FL_NO", MySqlDbType.VarChar,10),
            ...
            Plat.Model.opt_pay_mx_lock model = new Plat.Model.opt_pay_mx_lock();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Plat.Model.opt_pay_mx_lock DataRowToModel(DataRow row)
        {
            Plat.Model.opt_pay_mx_lock model = new Plat.Model.opt_pay_mx_lock();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM opt_pay_mx_lock ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from opt_pay_mx_lock T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "opt_pay_mx_lock";
