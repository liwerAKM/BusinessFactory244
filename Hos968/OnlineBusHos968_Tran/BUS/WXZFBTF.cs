...
namespace OnlineBusHos968_Tran.BUS
{
    class WXZFBTF
    {
        public static string B_WXZFBTF(string json_in)
        {
            ...
            try
            {
                WXZFBTF_M.WXZFBTF_IN _in = JSONSerializer.Deserialize<WXZFBTF_M.WXZFBTF_IN>(json_in);
                ...
                else if (GlobalVar.DoBussiness == "1")
                {
                    ...
                    if (GlobalVar.Linux == "0")
                    {
                        ...
                        {
                            OnlineBusHos968_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder builder = new OnlineBusHos968_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder();
                            ...
                            OnlineBusHos968_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder F2FPayResult = InDataRe.GetBusinessData<OnlineBusHos968_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder>(Key);
