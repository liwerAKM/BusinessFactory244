...
namespace Log.Core.MySQLDAL
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public readonly static string connectionString = ConnectionStringMySQL;
    ...
    /// Copyright (C) Soft
    /// </summary>
    public abstract class DbHelperMySQL_MYSPRING
    {
        /// <summary>
        /// 获取MySQL连接字符串
        /// </summary>
    ...
    /// Copyright (C) Soft
    /// </summary>
    public abstract class DbHelperMySQL_MYSPRINGLOG
    {
        /// <summary>
        /// 获取MySQL连接字符串
        /// </summary>
        ...
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public readonly static string connectionString = ConnectionStringMySQL;
        public DbHelperMySQL_MYSPRINGLOG()
        {
        }
