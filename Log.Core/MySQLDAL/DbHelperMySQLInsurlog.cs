...
namespace Log.Core.MySQLDAL
{
    ...
    /// Copyright (C) Soft
    /// </summary>
    public abstract class DbHelperMySQLInsurlog
    {

        /// <summary>
        /// 获取MySQL连接字符串
        /// </summary>
        public static string ConnectionStringInsurLogMySQL
        {
            get
            {
                string _connectionString = ConfigurationManager.AppSettings["ConnectionStringInsurLogMySQL"];
        ...
        public readonly static string connectionString = ConnectionStringInsurLogMySQL;
        public DbHelperMySQLInsurlog()
        {
        }
