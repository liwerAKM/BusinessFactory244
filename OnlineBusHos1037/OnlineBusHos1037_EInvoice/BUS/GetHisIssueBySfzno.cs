...
using OnlineBusHos1037_EInvoice.Model;
using Soft.Core;
...
namespace OnlineBusHos1037_EInvoice.BUS
{
    class GetHisIssueBySfzno
    {
        public static string B_GetHisIssueBySfzno(string json_in)
        {
            ...
            try
            {
                ...
                dic.Add("Bizcode", FormatHelper.GetStr(_in.YLCARD_NO));//发票号

                //if (string.IsNullOrEmpty(SFZ_NO))//无身份证时查院内信息
                //{
                //    string posturl = "http://130.150.206.40:8001/service.asmx";
                //    string inxml = string.Format("<ROOT><HEADER><TYPE>GETPATINFO</TYPE><CZLX>4</CZLX></HEADER><BODY><YLCARD_TYPE>6</YLCARD_TYPE><YLCARD_NO>{0}</YLCARD_NO><SFZ_NO></SFZ_NO><PAT_NAME></PAT_NAME><HOS_ID>133</HOS_ID><lTERMINAL_SN>qhzzj1</lTERMINAL_SN><USER_ID>qhzzj001</USER_ID></BODY></ROOT>", _in.YLCARD_NO);
