    ...
    class GETPATRECORD
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                {
                    BIRTHDAY=QHZZJCommonFunction.GetBirthdayByIDCard(SFZ_NO);
                }
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "NATIONAL", "");
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "BARCODE", "");//高淳中his要求添加
                ...
                try
                {
                    ...
                    else if(dtrev.Columns.Contains("BARCODE"))
                    {
