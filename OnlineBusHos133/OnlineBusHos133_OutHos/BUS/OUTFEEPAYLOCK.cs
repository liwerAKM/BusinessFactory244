        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                foreach (Model.OUTFEEPAYLOCK_M.PRE pre in _in.PRELIST)
                {
                    ...
                    XmlDocument doc = QHXmlMode.GetBaseXml("OUTFEEPAYLOCK", "0");
                    ...
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "lTERMINAL_SN", _in.lTERMINAL_SN);
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", _in.YLCARD_NO);
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_TYPE", _in.YLCARD_TYPE);
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "SFZ_NO", _in.SFZ_NO);
