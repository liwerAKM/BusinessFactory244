        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                if (_in.YLCARD_TYPE == "2")
                {
                    ...
                    {
                        dataReturn.Code = 222;//未调用his直接冲正
                ...
                */
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "JS_OUT", string.IsNullOrEmpty(_in.PAYINSUFEESTR) ? "" : _in.PAYINSUFEESTR);
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YJS_IN", "");
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YJS_OUT", "");
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YB_IN", "");
