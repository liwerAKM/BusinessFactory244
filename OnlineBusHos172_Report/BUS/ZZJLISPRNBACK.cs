...
namespace OnlineBusHos172_Report.BUS
{
    class ZZJLISPRNBACK
    {
        ...
        public static string A_ZZJLISPRNBACK(string json_in)
        {
            DataReturn dataReturn = new DataReturn();
            string json_out = "";
            try
            {
                ...
                reportDt.Columns.Add("ReportCode", typeof(string));
                reportDt.Columns.Add("UserName", typeof(string));


                DataRow dataRow = reportDt.NewRow();
                dataRow["ReportCode"] = _in.REPORT_SN;
                dataRow["UserName"] = _in.LTERMINAL_SN;
                ...
                string MethodName = "UpdatePrintFlagByReportID";
