        ...
        public static string B_WXZFBTF(string json_in)
        {
            ...
            try
            {
                ...
                if (_in.DEAL_TYPE == "98")
                {
                    ...
                    QHModel.ORDERREFUND.Request request = new QHModel.ORDERREFUND.Request();
                    //request.CLIENT_ID = ConfigurationManager.AppSettings["CLIENT_ID"];
                    request.CLIENT_ID = "17203";
                    request.PAY_TYPE = "201";
                    request.HOS_ID = _in.QUERYID;
                    ...
                    QHModel.ORDERREFUND.Response F2FRefundResult = InDataRe.GetBusinessData<QHModel.ORDERREFUND.Response>(Key);
                    if (F2FRefundResult.CLBZ == "0")
                    {
                        _out.STATUS = "1";
                    }
                    else
