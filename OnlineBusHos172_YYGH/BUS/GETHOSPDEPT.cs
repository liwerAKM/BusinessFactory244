            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        if (_in.LTERMINAL_SN.Equals("ZZJ10"))
                        {
                            DataRow[] dataRows = dtdept.Select("DEPT_CODE='0597'");
                            //dtdept = dataRows.CopyToDataTable();

                            dtdept = System.Data.DataTableExtensions.CopyToDataTable(dataRows);
                        }
