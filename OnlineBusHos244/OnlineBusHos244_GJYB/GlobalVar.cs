...
using OnlineBusHos244_GJYB.BUS;
using Soft.Core;
using System;
            ...
            try
            {
                if (callmode == "0")//webservice
                {
                    ...
                    try
                    {
                        ...
                        PBusHos244_GJYB.WriteLog("QuerySoapWebService", ex.Message, doc_sec.InnerText);



                    }
                    his_rtnxml = doc_sec.InnerText;
                    PBusHos244_GJYB.WriteLog("his_rtnxml", his_rtnxml, his_rtnxml);
                }
                ...
                try
                {
                    ...
                    PBusHos244_GJYB.WriteLog("AESExample.AESDecrypt", "AESExample.AESDecrypt", "AESExample.AESDecrypt");
