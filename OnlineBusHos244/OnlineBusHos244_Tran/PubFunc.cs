...
namespace OnlineBusHos244_Tran
{
    public class PubFunc
    {
        ...
        public static InteractiveData F2FPay<T>(string Hos_id, T IndataT, string ServiceName)
        {
            ...
            string url = @"http://10.0.0.83:8017/AliPay/WebServiceF2F.asmx";
            SqlSugarModel.SysConfig model = db.Queryable<SqlSugarModel.SysConfig>().Where(t => t.HOS_ID == "244" && t.config_key == "F2FPAY_URL").First();//江北单独处理44
            //if (model != null)
            //{
