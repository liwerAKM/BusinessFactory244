    ...
    class GETSCHINFO
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                //his_rtnxml= "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><HEADER><TYPE>GETSCHINFO</TYPE><CZLX>0</CZLX></HEADER><BODY><CLBZ>0</CLBZ><CLJG>(TYPE:GETSCHINFO)成功</CLJG><DEPTLIST /><DOCLIST><DOC><DEPT_CODE>00010</DEPT_CODE><DEPT_NAME>口腔科</DEPT_NAME><SCH_TIME>下午</SCH_TIME><DOC_NO>F0067</DOC_NO><DOC_NAME>章程</DOC_NAME><SCH_TYPE>2</SCH_TYPE><REGISTER_TYPE>002</REGISTER_TYPE><STATUS /><COUNT_REM>110</COUNT_REM><GH_FEE>0.0</GH_FEE><ZL_FEE>10</ZL_FEE><START_TIME>13:00:00</START_TIME><END_TIME>23:59:59</END_TIME><CAN_WAIT>0</CAN_WAIT><DEPT_ORDER>00010</DEPT_ORDER><YB_CODE>110200006-a%10%001102000010000</YB_CODE><DOC_ORDER /><DOC_NO_GJM>D320116023528</DOC_NO_GJM></DOC><DOC><DEPT_CODE>00010</DEPT_CODE><DEPT_NAME>口腔科</DEPT_NAME><SCH_TIME>上午</SCH_TIME><DOC_NO>F0067</DOC_NO><DOC_NAME>章程</DOC_NAME><SCH_TYPE>2</SCH_TYPE><REGISTER_TYPE>002</REGISTER_TYPE><STATUS /><COUNT_REM>110</COUNT_REM><GH_FEE>0.0</GH_FEE><ZL_FEE>10</ZL_FEE><START_TIME>00:00:00</START_TIME><END_TIME>13:00:00</END_TIME><CAN_WAIT>0</CAN_WAIT><DEPT_ORDER>00010</DEPT_ORDER><YB_CODE>110200006-a%10%001102000010000</YB_CODE><DOC_ORDER /><DOC_NO_GJM>D320116023528</DOC_NO_GJM></DOC></DOCLIST></BODY></ROOT>";
                ...
                try
                {
                    ...
                    if (dtDoc != null && dtDoc.Rows.Count > 0)
                    {
                        foreach (DataRow dr in dtDoc.Rows)
                        {
                            ...
                            doctor.SCH_DATE = dtDoc.Columns.Contains("SCH_DATE") ? DateTime.Now.ToString("yyyy-MM-dd") : DateTime.Now.ToString("yyyy-MM-dd");
