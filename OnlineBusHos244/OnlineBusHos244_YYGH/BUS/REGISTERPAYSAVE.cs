    ...
    class REGISTERPAYSAVE
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "INNERORDERNO", string.IsNullOrEmpty(_in.INNERORDERNO) ? "" : _in.INNERORDERNO.Trim());
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "OUTERORDERNO", string.IsNullOrEmpty(_in.OUTERORDERNO) ? "" : _in.OUTERORDERNO.Trim());
                ...
                if (_in.YLCARD_TYPE == "2" && !string.IsNullOrEmpty(_in.JEALL) && FormatHelper.GetDecimal(_in.JEALL) != 0)
                {
                    ...
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput1101", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput1101"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2201", FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2201"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2201", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2201"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2203", FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2203"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2204", FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2204"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2204", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2204"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2207", FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2207"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2207", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2207"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput5360", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput5360"]));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PSN_NO", _in.YLCARD_NO);
                }
