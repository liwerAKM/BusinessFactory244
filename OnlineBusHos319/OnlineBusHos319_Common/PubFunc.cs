...
namespace OnlineBusHos319_Common
{
    public class PubFunc
    {
        ...
        /// <param name="his_rtnxml"></param>
        /// <returns></returns>
        public static bool  CallHISService(string HOS_ID,string inputjson, string type, ref string his_rtnxml)
        {
            bool flag = false;
            ...
            try
            {
                ...
                string Url = hosconfig.Service_URL;
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url);
                request.Method = "POST";
                request.ContentType = "application/json";
                request.Headers.Add("hsb-method", "ExecMethod");
                request.Headers.Add("hsb-biz", type);
                request.Headers.Add("hsb-token", "admin");
                request.Headers.Add("hsb-user-id", "QHZZJ");
                ...
                his_rtnxml = reader.ReadToEnd();
                flag = true;
            }
            catch (Exception ex)
            {
                his_rtnxml = ex.Message;
                flag = false;
            }
