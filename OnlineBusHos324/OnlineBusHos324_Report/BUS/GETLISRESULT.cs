...
using System.Text;
using System.Xml;
using OnlineBusHos324_Report.Model;

namespace OnlineBusHos324_Report.BUS
{
    class GETLISRESULT
    {
        public static string B_GETLISRESULT(string json_in)
        {
            ...
            try
            {
                ...
                XmlDocument doc = QHXmlMode.GetBaseXml("GETLISRESULT", "1");
                ...
                try
                {
                    ...
                    try
                    {
                        DataTable dtlisreport = XMLHelper.X_GetXmlData(xmldoc, "ROOT/BODY/LISREPORTCOMMONLIST").Tables[0] ;
                        _out.LISREPORTCOMMONLIST = dtlisreport;
