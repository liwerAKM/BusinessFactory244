...
namespace OnlineBusHos324_Report.BUS
{
    class GETRISRESULT
    {
        public static string B_GETRISRESULT(string json_in)
        {
            ...
            try
            {
                GETRISRESULT_M.GETRISRESULT_IN _in = JSONSerializer.Deserialize<GETRISRESULT_M.GETRISRESULT_IN>(json_in);
                GETRISRESULT_M.GETRISRESULT_OUT _out = new GETRISRESULT_M.GETRISRESULT_OUT();
                XmlDocument doc = QHXmlMode.GetBaseXml("GETRISRESULT", "1");
