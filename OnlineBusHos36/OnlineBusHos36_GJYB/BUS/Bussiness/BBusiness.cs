...
using OnlineBusHos36_GJYB.Model;
using Soft.Core;
using System;
...
namespace OnlineBusHos36_GJYB.BUS
{
    ...
    public class BBusiness : IBusiness
    {
        ...
        public virtual DataReturn REGTRY(string injson)
        {
            ...
            XmlDocument doc = QHXmlMode.GetBaseXml("GETCHSREGTRYZZJ", "1");
        ...
        public virtual DataReturn OUTPTRY(string injson)
        {
            ...
            XmlDocument doc = QHXmlMode.GetBaseXml("GETCHSOUTPTRYZZJ", "1");
        ...
        public virtual DataReturn SETTLE(string injson)
        {
            ...
            if (ISGH == "1")
            {
                meodname = "GETCHSREGSAVEZZJ";
            }
            else
            {
                meodname = "GETCHSOUTPSAVEZZJ";
            }
