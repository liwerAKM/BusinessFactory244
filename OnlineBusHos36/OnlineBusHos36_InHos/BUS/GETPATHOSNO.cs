...
namespace OnlineBusHos36_InHos.BUS
{
    ...
    class GETPATHOSNO
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                Model.GETPATHOSNO_M.GETPATHOSNO_IN _in = JSONSerializer.Deserialize<Model.GETPATHOSNO_M.GETPATHOSNO_IN>(json_in);
                Model.GETPATHOSNO_M.GETPATHOSNO_OUT _out = new Model.GETPATHOSNO_M.GETPATHOSNO_OUT();
