    ...
    class OUTFEEPAYSAVE
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "USER_ID", string.IsNullOrEmpty(_in.LTERMINAL_SN) ? "" : _in.LTERMINAL_SN.Trim());
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DEAL_TYPE", string.IsNullOrEmpty(_in.QUERYID) ? "":_in.DEAL_TYPE);
                ...
                #region 医保
                if (_in.YLCARD_TYPE == "2" && _in.SETTLE_TYPE != "1")
                {
                    ...
                    DataTable dtybpsn = DbHelperMySQLInsur.Query("select * from chs_psn where psn_no='" + _in.YLCARD_NO + "'").Tables[0];
                    ...
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PAT_NAME", FormatHelper.GetStr(dtybpsn.Rows[0]["psn_name"]));
                ...
                try
                {
                    ...
                    */
                    ...
                    _out.RCPT_WINDOWS = dtrev.Columns.Contains("RCPT_WINDOWS") ? dtrev.Rows[0]["RCPT_WINDOWS"].ToString() : "";
                    dataReturn.Code = 0;
