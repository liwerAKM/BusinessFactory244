    ...
    class REGISTERPAYSAVE
    {
        ...
        public static string Business(string json_in)
        {
            ...
            try
            {
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "QUERYID", string.IsNullOrEmpty(_in.QUERYID) ? DateTime.Now.ToString("yyyyMMddHHmmssfff") + _in.LTERMINAL_SN : _in.QUERYID.Trim());

                #region 医保
                if (_in.YLCARD_TYPE == "2" && !string.IsNullOrEmpty(_in.JEALL) && FormatHelper.GetDecimal(_in.JEALL) != 0)
                {
                    ...
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput1101", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput1101"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2201", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2201"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2201", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2201"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2203", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2203"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2204", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2204"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2204", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2204"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2207", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsInput2207"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2207", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2207"])));
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput5360", PubFunc.Base64Encode(FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput5360"])));
                }

                if (_in.YLCARD_TYPE == "2" && FormatHelper.GetDecimal(_in.JEALL) == 0 && !string.IsNullOrEmpty(_in.YLCARD_NO))//0元号特殊处理
                {
                    DataTable dtPsnDetail = DbHelperMySQLInsur.Query("select * from chs_psn where psn_no='" + _in.YLCARD_NO + "'").Tables[0];
                    string chsOutput1101 = "";
                    if (dtPsnDetail.Rows.Count > 0)
                    {
                        chsOutput1101 = PubFunc.Base64Encode(FormatHelper.GetStr(dtPsnDetail.Rows[0]["chsOutput1101"]));
                    }
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput1101", chsOutput1101);
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2201", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2201", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2203", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2204", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2204", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsInput2207", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput2207", "");
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput5360", "");
                }
                ...
                try
                {
                    ...
                    {
                        dataReturn.Code = dtrev.Rows[0]["CLBZ"].ToString() == "222" ? 222 : 1;
                    ...
                    _out.APPT_ORDER = dtrev.Columns.Contains("BH") ? dtrev.Rows[0]["BH"].ToString() : "";
                    ...
                    _out.DISE_NAME = dtrev.Columns.Contains("DISE_NAME") ? dtrev.Rows[0]["DISE_NAME"].ToString() : "";
                    #region  平台数据保存
                    try
                    {
