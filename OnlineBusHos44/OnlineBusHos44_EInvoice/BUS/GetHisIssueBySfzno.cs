...
using OnlineBusHos44_EInvoice.Model;
using Soft.Core;
using Newtonsoft.Json.Linq;

namespace OnlineBusHos44_EInvoice.BUS
{
   public  class GetHisIssueBySfzno
    {
        public static string B_GetHisIssueBySfzno(string json_in)
        {
            ...
            try
            {
                ...
                //his_rtnxml = "{\"ROOT\":{\"HEADER\":{\"MODULE\":\"\",\"CZLX\":\"\",\"TYPE\":\"GETHISISSUEBYSFZNO\",\"source\":\"ZZJ\"},\"BODY\":{\"hisissuelist\":[{\"invoice_code\":\"32060124\",\"invoice_number\":\"0393262610\",\"total_amount\":12.00,\"invoicing_party_name\":\"南京江北医院\",\"payer_party_code\":\"341***********2246\",\"payer_party_name\":\"张秀莲\",\"sftypename\":\"门诊\",\"STATUS\":\"\",\"saveddate_time\":\"2024-06-12 16:48\",\"isprint\":0.0,\"print_times\":0,\"biztype\":\"06\",\"biztypename\":\"挂号\",\"invoice_url\":\"http://einvoice.jsczt.cn/d/47301212830a61237c0\",\"HOS_NAME\":\"南京江北医院\"}],\"CLBZ\":\"0\",\"CLJG\":\"\"}}}";
                ...
                foreach (HisissuelistItem item in body.hisissuelist)
                {
                    if (FormatHelper.GetDecimal(item.isprint)== 0)
                    {
                        ...
                        //if (list.SFTYPENAME == "门诊") { continue; }
