    ...
    class GETPATHOLOGYREPORT
    {
        public static string B_GETPATHOLOGYEPORT(string json_in)
        {
            ...
            try
            {
                ...
                XmlDocument doc = QHXmlMode.GetBaseXml("GETPATHOLOGYREPORT", "1");
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", _in.YLCARD_NO.Trim());
                ...
                try
                {
                    ...
                    try
                    {
                        dtpatholotyreport = ds.Tables["PATHOLOGYREPORT"];
                    ...
                    {
                        dataReturn.Code = 5;
                        dataReturn.Msg = "解析出参失败,请检查出参:"+ex.Message;
                        dataReturn.Param = ex.ToString();

                        goto EndPoint;
                    }
                    _out.REPORT_ALL_NUM = dtrev.Rows[0]["REPORT_ALL_NUM"].ToString();
                    _out.REPORT_PRINT_NUM = dtrev.Rows[0]["REPORT_PRINT_NUM"].ToString();
                    _out.REPORT_AUDIT_NUM = dtrev.Rows[0]["REPORT_AUDIT_NUM"].ToString();
