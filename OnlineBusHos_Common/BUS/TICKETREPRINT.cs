...
namespace OnlineBusHos172_Common.BUS
{
    class TICKETREPRINT
    {
        public static string B_TICKETREPRINT(string json_in)
        {
            ...
            try
            {
                ...
                //入参校验
                if (string.IsNullOrEmpty(_in.SFZ_NO)&& string.IsNullOrEmpty(_in.HOSPATID))
                {
                    dataReturn.Code = 4;
                ...
                if (string.IsNullOrEmpty(_in.SFZ_NO))
                {
                    ...
                    if (patInfo.Equals(null) || string.IsNullOrEmpty(patInfo.SFZ_NO))
                    {
                        dataReturn.Code = 5;
