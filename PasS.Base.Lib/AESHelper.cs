...
namespace PasS.Base.Lib
{
    ...
    {
        const string Key = "8468CEFB719D6C00294CBD9ZDP6D2DFJ";
        ...
        {
            if (string.IsNullOrEmpty(pherText))
            {
                return "";
            }
        ...
        {
            return GetMD5(encryptString + encryptKey );
        }
        ...
        {
            return GetMD5(encryptString + Key );
        }
