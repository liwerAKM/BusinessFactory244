...
namespace PasS.Base.Lib
{
    ...
    public class NewIdHelper
    {
        ...
        /// <summary>
        ///24位 yyyyMMddHHmmssfff+7位随机数
        /// </summary>
        /// <returns></returns>
        public static string NewOrderId24
        {
            get
            {
                Random rnd = new Random(Guid.NewGuid().GetHashCode());
                return DateTime.Now.ToString("yyyyMMddHHmmssfff") + (rnd.Next(9999999)).ToString("D7");
            }
        }
        /// <summary>
        ///24位 yyMMddHHmmssfff+9位随机数
        /// </summary>
        /// <returns></returns>
        public static string NewOrderId24_2
        {
            get
            {
                Random rnd = new Random(Guid.NewGuid().GetHashCode());
                return DateTime.Now.ToString("yyMMddHHmmssfff") + (rnd.Next(999999999)).ToString("D9");
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static string NewOrderId12
        {
            get
            {
                Random rnd = new Random(Guid.NewGuid().GetHashCode());
                return DateTime.Now.ToString("HHmmssfff") + (rnd.Next(999)).ToString("D3");
            }
        }
