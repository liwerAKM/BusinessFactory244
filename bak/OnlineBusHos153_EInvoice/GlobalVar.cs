...
namespace OnlineBusHos153_EInvoice
{
    class GlobalVar
    {
        ...
        public static string GetConfig(string configname)
        {
            ...
            docini.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin", "OnlineBusHos153_EInvoice.dll.config"));
