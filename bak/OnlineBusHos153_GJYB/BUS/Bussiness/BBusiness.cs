...
namespace OnlineBusHos153_GJYB.BUS
{
    ...
    public class BBusiness : IBusiness
    {
        ...
        public virtual DataReturn REGTRY(string injson)
        {
            ...
            //DataTable dtregister_appt = DbHelperMySQL.Query("select * from register_appt where HOS_SN='"+HOS_SN+"'").Tables[0];
            //if (dtregister_appt.Rows.Count > 0)
            //{ }
            //DataTable  = DbHelperMySQL.Query("select * from DEPT_INFO where DEPT_CODE='" + _in.DEPT_CODE + "'").Tables[0];
            //if (dtregister_appt.Rows.Count > 0)
            //{ }
            //DataTable dtregister_appt = DbHelperMySQL.Query("select * from DEPT_INFO where DEPT_CODE='" + _in.DEPT_CODE + "'").Tables[0];
            ...
            DataTable  dt_dept= DbHelperMySQLZZJ.Query("select * from DEPT_INFO where DEPT_CODE='" + _in.DEPT_CODE + "'").Tables[0];
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DEPT_NAME", dt_dept.Rows.Count>0?FormatHelper.GetStr(dt_dept.Rows[0]["DEPT_NAME"]):"");

            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DOC_NO", string.IsNullOrEmpty(_in.DOC_NO) ? "" : _in.DOC_NO.Trim());
            DataTable dt_doc = DbHelperMySQLZZJ.Query("select * from DOC_INFO where DOC_NO='" + _in.DOC_NO + "'").Tables[0];
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DOC_NAME", dt_doc.Rows.Count > 0 ? FormatHelper.GetStr(dt_doc.Rows[0]["DOC_NAME"]) : "");
            ...
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "SFZ_NO", chspsn.certno);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PAT_NAME", chspsn.psn_name);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", chspsn.psn_no);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLTYPE","11");
        ...
        public virtual DataReturn OUTPTRY(string injson)
        {
            ...
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DJ_DATE",DateTime.Now.ToString("yyyy-MM-dd"));
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DJ_TIME", DateTime.Now.ToString("HH:mm"));
            ...
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DOC_NO", string.IsNullOrEmpty(_in.DOC_NO) ? "" : _in.DOC_NO.Trim());
            DataTable dt_doc = DbHelperMySQLZZJ.Query("select * from DOC_INFO where DOC_NO='" + _in.DOC_NO + "'").Tables[0];
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DOC_NAME", dt_doc.Rows.Count > 0 ? FormatHelper.GetStr(dt_doc.Rows[0]["DOC_NAME"]) : _in.DOC_NAME);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "MDTRT_CERT_TYPE", string.IsNullOrEmpty(_in.MDTRT_CERT_TYPE) ? "" : _in.MDTRT_CERT_TYPE.Trim());
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "MDTRT_CERT_NO", string.IsNullOrEmpty(_in.MDTRT_CERT_NO) ? "" : _in.MDTRT_CERT_NO.Trim());
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput1101", chsOutput1101);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "SFZ_NO", chspsn.certno);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PAT_NAME", chspsn.psn_name);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PAT_TYPE","11");

            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", chspsn.certno);
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_TYPE", "2");

            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLTYPE", "11");
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLLB", "11");
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "MZNO", "");
            XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "SHBZKH", chspsn.certno);
        ...
        public virtual DataReturn SETTLE(string injson)
        {
            ...
            string TRAN_ID = HOS_ID + "_" + (ISGH == "1" ? "01" : "02") +"_"+ (ISGH == "1" ? HOS_SN : PAY_ID);            
            ...
            if (ISGH == "1")
            {
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "MDTRT_CERT_TYPE", string.IsNullOrEmpty(_in.MDTRT_CERT_TYPE) ? "" : _in.MDTRT_CERT_TYPE.Trim());
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "MDTRT_CERT_NO", string.IsNullOrEmpty(_in.MDTRT_CERT_NO) ? "" : _in.MDTRT_CERT_NO.Trim());
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "chsOutput1101", chspsn.chsOutput1101);
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "SFZ_NO", chspsn.certno);
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "PAT_NAME", chspsn.psn_name);
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", chspsn.psn_no);
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLTYPE", "11");
        ...
        public virtual DataReturn REFUND(string injson)
        {
            ...
            jin2208data["psn_no"] = "32130000000000001001750456";
