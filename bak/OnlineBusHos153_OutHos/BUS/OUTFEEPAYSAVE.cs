...
using OnlineBusHos153_OutHos.Model;
using Soft.Core;
using System.Xml;
using System.Data;
...
namespace OnlineBusHos153_OutHos.BUS
{
    class OUTFEEPAYSAVE
    {
        ...
        public static string UnDoBusiness(string json_in)
        {
            ...
            try
            {
                ...
                XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "YLCARD_NO", string.IsNullOrEmpty(_in.YLCARD_NO) ? "" : _in.SFZ_NO.Trim());
                ...
                if (_in.YLCARD_TYPE == "2")
                {
                    ...
                    XMLHelper.X_XmlInsertNode(doc, "ROOT/BODY", "DJ_OUT", FormatHelper.GetStr(dtybjslog.Rows[0]["chsOutput2201"]));
                }
                else
                {
