            ...
            try
            {
                ...
                else if (GlobalVar.DoBussiness == "1")
                {
                    ...
                    if (GlobalVar.Linux == "0")
                    {
                        ...
                        {
                            OnlineBusHos153_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder builder = new OnlineBusHos153_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder();
                            ...
                            OnlineBusHos153_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder F2FPayResult = InDataRe.GetBusinessData<OnlineBusHos153_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder>(Key);
