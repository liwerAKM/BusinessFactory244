            ...
            try
            {
                ...
                else if (GlobalVar.DoBussiness == "1")
                {
                    ...
                    if (GlobalVar.Linux == "0")
                    {
                        ...
                        {
                            OnlineBusHos8_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder builder = new OnlineBusHos8_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder();
                            ...
                            OnlineBusHos8_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder F2FPayResult = InDataRe.GetBusinessData<OnlineBusHos8_Tran.F2FPAY.Windows.WxPayTradeRefundBuilder>(Key);
