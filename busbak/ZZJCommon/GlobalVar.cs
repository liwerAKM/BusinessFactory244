...
namespace ZZJCommon
{
    class GlobalVar
    {
        ...
        public static string GetConfig(string configname)
        {
            ...
            docini.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin", "ZZJCommon.dll.config"));
        ...
        public static bool CALLSERVICE(string HOS_ID, string inxml, ref string his_rtnxml)
        {
            ...
            catch (Exception ex)
            {
                ...
                modLogHos.inXml = inxml;
                modLogHos.outTime = DateTime.Now;
                modLogHos.outXml = ex.ToString() + ";" + GlobalVar.DoBussiness + ";" + GlobalVar.callmode + ";" + GlobalVar.posturl + ";" + GlobalVar.parameter + ";" + GlobalVar.use_encryption + ";" + GlobalVar.MethodName;
                new Log.Core.MySQLDAL.DalLogHosError().Add(modLogHos);
                his_rtnxml = ex.ToString()+";"+ GlobalVar.DoBussiness + ";" + GlobalVar.callmode + ";" + GlobalVar.posturl + ";" + GlobalVar.parameter + ";" + GlobalVar.use_encryption + ";" + GlobalVar.MethodName;
                return false;
            }
            return true;
        }
