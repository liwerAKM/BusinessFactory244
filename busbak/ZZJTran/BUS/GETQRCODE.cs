            ...
            try
            {
                ...
                else if (GlobalVar.DoBussiness == "1")
                {
                    ...
                    if (GlobalVar.Linux == "0")
                    {
                        ...
                        {
                            ZZJTran.F2FPAY.Windows.WxPayTradePrecreateBuilder builder = new ZZJTran.F2FPAY.Windows.WxPayTradePrecreateBuilder();
                            builder.out_trade_no = out_trade_no;
                            ...
                            ZZJTran.F2FPAY.Windows.WxPayTradePrecreateBuilder F2FPayResult = InDataRe.GetBusinessData<ZZJTran.F2FPAY.Windows.WxPayTradePrecreateBuilder>(Key);
                    ...
                    else if (GlobalVar.Linux == "1")
                    {
                        ...
                        else if(_in.DEAL_TYPE== "1")//微信
                        {
                            ...
                            F2FPAY.Linux.WxPayTradePrecreateBuilder F2FPayResult = InDataRe.GetBusinessData<ZZJTran.F2FPAY.Linux.WxPayTradePrecreateBuilder>(Key);
                            _out.HIS_RTNXML = F2FPayResult.DateRe;
                            if (F2FPayResult.result_code.ToString() == "SUCCESS")
                            {
                                #region 保存wechat_tran表数据
