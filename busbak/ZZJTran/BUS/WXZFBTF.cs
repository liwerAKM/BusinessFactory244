            ...
            try
            {
                ...
                else if (GlobalVar.DoBussiness == "1")
                {
                    ...
                    if (GlobalVar.Linux == "0")
                    {
                        ...
                        {
                            ZZJTran.F2FPAY.Windows.WxPayTradeRefundBuilder builder = new ZZJTran.F2FPAY.Windows.WxPayTradeRefundBuilder();
                            ...
                            ZZJTran.F2FPAY.Windows.WxPayTradeRefundBuilder F2FPayResult = InDataRe.GetBusinessData<ZZJTran.F2FPAY.Windows.WxPayTradeRefundBuilder>(Key);
